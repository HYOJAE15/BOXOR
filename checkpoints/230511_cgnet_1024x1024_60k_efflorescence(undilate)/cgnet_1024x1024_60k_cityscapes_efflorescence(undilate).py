...
data_root = '/home/user/WindowsShare/05. Data/02. Training&Test/102. Autolabel-train/02. efflorescence/raw.ver.0.2'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        data_root=
        '/home/user/WindowsShare/05. Data/02. Training&Test/102. Autolabel-train/02. efflorescence/raw.ver.0.2',
...
work_dir = '/home/user/mmsegmentation/work_dirs/230511_cgnet_1024x1024_60k_efflorescence(undilate)'
gpu_ids = range(0, 2)
auto_resume = False
